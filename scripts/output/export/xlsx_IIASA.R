...
projects <- list(
  ...
  ScenarioMIP = list(model = "REMIND-MAgPIE 3.5-4.11",
                     ...
                     renameScen = c(
                      ...
                      "SMIPv08-L-SSP2-PkPrice400-def" = "SSP2 - Low Emissions",
                      "SMIPv08-L-SSP1-EcPrice300-var_yr2035" = "SSP1 - Low Emissions_c",
                      "SMIPv08-L-SSP2-PkPrice400-var_yr2035" = "SSP2 - Low Emissions_c",
                      "SMIPv08-L-SSP1-EcPrice300-var_yr2050" = "SSP1 - Low Emissions_d",
                      "SMIPv08-L-SSP2-PkPrice400-var_yr2050" = "SSP2 - Low Emissions_d",
                      "SMIPv08-VLHO-SSP2-EcPrice1300-def" = "SSP2 - Low Overshoot",
                      "SMIPv08-VLHO-SSP2-EcBudg500-var_natveg" = "SSP2 - Low Overshoot_b",
