...
projects <- list(
  ...
  ScenarioMIP = list(model = "REMIND-MAgPIE 3.4-4.8",
                     ...
                     renameScen = c("SMIPv04-H-SSP3-rollBack-def" = "SSP3 - High Emissions",
                                    "SMIPv04-M-SSP2-NPi2025-def" = "SSP2 - Medium Emissions",
                                    "SMIPv04-ML-SSP2-PkBudg1500-def" = "SSP2 - Medium-Low Emissions",
                                    "SMIPv04-L-SSP2-PkBudg1000-def" = "SSP2 - Low Emissions",
                                    "SMIPv04-VLHO-SSP2-EcBudg400-def" = "SSP2 - Low Overshoot",
                                    "SMIPv04-VLLO-SSP2-PkBudg650-var" = "SSP2 - Very Low Emissions",
                                    "SMIPv04-VLLO-SSP1-PkBudg650-def" = "SSP1 - Very Low Emissions",
                                    "SMIPv04-VLLO-SSP2-PkBudg650-var_highCO2price" = "SSP2 - Very Low Emissions_a",
                                    "SMIPv04-VLLO-SSP1-PkBudg650-var_highCO2price" = "SSP1 - Very Low Emissions_a",
                                    "SMIPv04-VLHO-SSP2-EcBudg400-var_plantation" = "SSP2 - Low Overshoot_b",
                                    "SMIPv04-L-SSP2-PkBudg1000-var_yr2035" = "SSP2 - Low Emissions_c",
                                    "SMIPv04-VLHO-SSP2-EcBudg400-var_yr2035" = "SSP2 - Low Overshoot_c",
                                    "SMIPv04-VLLO-SSP2-PkBudg650-var_yr2035" = "SSP2 - Very Low Emissions_c",
                                    "SMIPv04-VLLO-SSP1-PkBudg650-var_yr2035" = "SSP1 - Very Low Emissions_c",
                                    "SMIPv04-L-SSP2-PkBudg1000-var_yr2050" = "SSP2 - Low Emissions_d",
                                    "SMIPv04-VLHO-SSP2-EcBudg400-var_yr2050" = "SSP2 - Low Overshoot_d"),
                     checkSummation = c("ScenarioMIP","NAVIGATE")),
