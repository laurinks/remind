...
p21_taxrevNetNegEmi_old0(ttot,all_regi)                             "reference level value of net-negative emissions tax" !! TO BE DELETED ONCE TESTS ARE COMPLETED
...
p21_taxrevNetNegEmi_old_iter(iteration,ttot,all_regi)               "track reference level value of net-negative emissions tax revenue over iterations" !! TO BE DELETED ONCE TESTS ARE COMPLETED
