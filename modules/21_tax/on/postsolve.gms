...
p21_taxrevNetNegEmi_old0(ttot,regi) = cm_frac_NetNegEmi_old * pm_taxCO2eqSum(ttot,regi) * vm_emiALLco2neg.l(ttot,regi);
...
display p21_taxrevNetNegEmi_old0, vm_emiALLco2neg.l, v21_emiALLco2neg_slack.l, vm_emiAll.l; !! TO BE DELETED ONCE TESTS ARE COMPLETED
...
p21_taxrevNetNegEmi_old_iter(iteration+1,ttot,regi) = v21_taxrevNetNegEmi_old.l(ttot,regi); !! TO BE DELETED ONCE TESTS ARE COMPLETED
